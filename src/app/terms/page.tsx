...
export const metadata: Metadata = {
  ...
  description: 'Terms and conditions for using the ENERGY MAN Batteries website and ordering products.',
};
...
export default function TermsPage() {
  const sections: { title: string; body: string[] }[] = [
    ...
    },
    {
      title: '3. Orders',
      body: [
        'Submitting an order enquiry does not automatically constitute a completed sale. An order is confirmed only after ENERGY MAN confirms availability, final pricing, and payment and delivery arrangements with you directly.',
      ],
    },
    {
      title: '4. Pricing',
    ...
    },
    {
      ...
      body: [
        'Battery installation should be carried out by qualified professionals where required. ENERGY MAN is not responsible for damage arising from incorrect installation, misuse or modification of a product.',
      ],
    },
    {
      title: '8. Warranty',
      body: [
        'Products may be covered by a manufacturer or ENERGY MAN warranty. Applicable warranty terms are communicated to the customer at the time of purchase.',
      ],
    },
    {
