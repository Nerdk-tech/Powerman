...
- **Changing the admin password:** edit `prisma/seed.ts` and `src/lib/bootstrap.ts` (search for `PowerMan2026!`), push, redeploy, and create a fresh database — or just change it in the code before your first deploy.
