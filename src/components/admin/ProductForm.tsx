      ...
      <section className="rounded-2xl bg-white p-6 shadow-card ring-1 ring-navy/5">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            ...
            <input name="name" value={name} onChange={(e) => setName(e.target.value)} required placeholder="e.g. POWERMAN Pro 75Ah Car Battery" className={INPUT} />
          </div>
          <div>
          ...
          <div>
            ...
            <input name="brand" defaultValue={product?.brand ?? 'POWERMAN'} required className={INPUT} />
          </div>
          <div>
            <label className={LABEL}>Model</label>
            <input name="model" defaultValue={product?.model ?? ''} placeholder="e.g. PM-AUTO-75MF" className={INPUT} />
          </div>
          <div>
            <label className={LABEL}>SKU</label>
            <input name="sku" defaultValue={product?.sku ?? ''} required placeholder="e.g. PM-AUTO-001" className={INPUT} />
          </div>
          <div>
