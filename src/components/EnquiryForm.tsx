    ...
    return (
      <div className="rounded-2xl border border-volt/40 bg-volt-50 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-charcoal/70">
          Thank you. The POWERMAN team will contact you shortly to confirm availability, pricing and delivery.
        </p>
        <button
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="text-xs text-charcoal/50">
        No payment required. POWERMAN will contact you to confirm availability, final pricing, payment and delivery.
      </p>
    </form>
  );
}
