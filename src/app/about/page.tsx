...
export const metadata: Metadata = {
  title: 'About Us',
  description:
    'ENERGY MAN is a battery sales and distribution company providing dependable power solutions for vehicles, solar systems, inverters, businesses and industry.',
};
      ...
      <section className="bg-navy py-14">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-navy-200 sm:text-base">
            The story, mission and promise behind ENERGY MAN Batteries.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto max-w-7xl gap-12 px-4 py-14 lg:grid lg:grid-cols-[1fr_400px]">
        <div>
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-charcoal/80">
            At ENERGY MAN, we believe reliable power starts with the right battery. We are a battery sales and
          ...
          <p className="mt-4 text-[15px] leading-relaxed text-charcoal/80">
            ...
            applications, ENERGY MAN is here to help. We are committed to providing quality products, helpful
          ...
          <div className="overflow-hidden rounded-2xl shadow-card ring-1 ring-navy/5">
            <div className="relative aspect-[4/3]">
              <Image
                ...
                alt="ENERGY MAN — quality batteries and power solutions"
                fill
