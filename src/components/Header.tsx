  ...
  return (
    <header className="sticky top-0 z-50 bg-navy text-white shadow-lg">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3">
        {/* LOGO — large and very visible */}
        <Link href="/" className="flex shrink-0 items-center" aria-label="POWERMAN Home">
          <span className="rounded-lg bg-white px-3 py-1.5 shadow-md ring-1 ring-white/40">
            <Image
              src={SITE_CONFIG.logoUrl}
              alt="POWERMAN Batteries"
              width={160}
              height={51}
              priority
