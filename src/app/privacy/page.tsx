  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 py-14">
        <div className="rounded-xl border-l-4 border-volt bg-volt-50 p-4 text-sm text-charcoal/75">
          <strong className="text-navy">Note:</strong> This policy should be reviewed and finalized for the actual
          business and applicable Nigerian privacy requirements before launch.
        </div>
