...
export const metadata: Metadata = {
  ...
  description:
    'Browse the full ENERGY MAN range — automotive, motorcycle, solar, inverter, lithium, heavy-duty, industrial batteries and accessories. Order directly on WhatsApp.',
};
...
function filterProducts(sp: SearchParams, all: Awaited<ReturnType<typeof getPublishedProducts>>) {
...
export default async function ShopPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const products = filterProducts(sp, all);
    ...
    <>
      ...
      <section className="bg-navy py-12">
        <div className="mx-auto max-w-7xl px-4">
          <p className="text-xs font-bold uppercase tracking-[0.2em] text-volt">The ENERGY MAN Catalogue</p>
